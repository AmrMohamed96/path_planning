...
if __name__ == '__main__':
	...
	rospy.Subscriber('rob1_CurrentPose', Int32MultiArray, robot_position_callback)
	...
	rospy.Subscriber('rob2_CurrentPose', Int32MultiArray, obst3_position_callback)
	rospy.Subscriber('rob3_CurrentPose', Int32MultiArray, obst4_position_callback)
	rospy.Subscriber('rob4_CurrentPose', Int32MultiArray, obst5_position_callback)
